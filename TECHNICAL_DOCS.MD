...
- **Output Enhancements**:
  - The streamer now logs which candle interval (e.g., '1m', '5m') from `config.js` it is using.
  - Each detected pivot is sequentially numbered (e.g., `HISTORICAL PIVOT #1 DETECTED:`), making it easier to track the total count.
