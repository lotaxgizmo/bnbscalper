...
export const multiPivotConfig = {
    ...
    cascadeSettings: {
        ...
        confirmationWindow: {
            ...
            '1h': 240,      // 🎯 OPTIMIZED: Wait up to 4 hours for 15m confirmation  
            '15m': 120,     // 🎯 OPTIMIZED: Wait up to 2 hours for 1m confirmation
            '5m': 30,       // 🎯 OPTIMIZED: Wait up to 30 minutes for 1m confirmation
